...
use kite::{Prompt, Color, Style};

fn main() {
    println!("{}\n", Color::Cyan.paint("=== Interactive Prompts Demo ===").style(Style::Bold));
    ...
    println!("\n{}", Color::Magenta.paint("=== Quick Survey ===").style(Style::Bold));
    ...
    if let Ok(email) = Prompt::input("Email address: ")
        ...
        println!("\n{}", Color::Green.paint("=== Survey Results ===").style(Style::Bold));
        println!("Email: {}", email);
        println!("Age: {}", age);
